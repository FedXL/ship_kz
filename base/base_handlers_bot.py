...
def add_doc_to_bd(doc_id, user_id, is_answer=False, manager=None, ):
    if is_answer:
    ...
    try:
        ...
        insert_1 = f"INSERT INTO messages (is_answer, storage_id) VALUES ({is_answer}, {user_id}) RETURNING id;"
...
def add_photo_to_bd(photo_id, user_id, is_answer=False, manager=None, ):
    if is_answer:
